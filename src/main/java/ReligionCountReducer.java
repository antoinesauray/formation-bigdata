 ...
 */
public class ReligionCountReducer extends org.apache.hadoop.mapreduce.Reducer<Text, IntWritable, Text, IntWritable> {

    private Map<String, Pair<String, Integer>> map;


    protected void setup(WordCountReducer.Context context)
            throws IOException,
    ...
    protected void cleanup(WordCountReducer.Context context)
            throws IOException,
            InterruptedException {
